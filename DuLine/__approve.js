...
module.exports = (text = [""], Com, Door, line = 0) => {
    ...
    if (text[0] == "approve") {
        if (text[1]) {
                        ...
                        if (text[3] == "String") {
                            ...
                            if (text[4]) {
                                try {
                                    ...
                                    if (err) {
                                        Console.gerror("Unknown error while creating a variable of type Int.", ["From: DuScript[Door] interpreter.", "Worker: __approve", "Line: " + line]);
                                        work = false;
                                    };
                                };
                            } else {
                            ...
                            if (text[4]) {
                                if (text[4] == "true") {
                                    ...
                                    Console.gerror("The value of a variable with type Bool is not allowed.", ["From: DuScript[Door] interpreter.", "Worker: __approve", "?: " + text[4], "Line: " + line]);
                                };
                            } else {
                            ...
                            if (text[4]) {
                                try {
                                    ...
                                    Console.gerror("Unknown error while creating a variable of type Array.", ["From: DuScript[Door] interpreter.", "Worker: __approve", "Line: " + line]);
                                    work = false;
                                };
                            } else {
                            ...
                            if (text[4]) {
                                try {
                                    ...
                                    Console.gerror("Unknown error while creating a variable of type Object.", ["From: DuScript[Door] interpreter.", "Worker: __approve", "Line: " + line]);
                                    work = false;
                                };
                            } else {
                            ...
                            Console.gerror("The type of the variable is not known.", ["From: DuScript[Door] interpreter.", "Worker: __approve", "?: " + text[3], "Line: " + line]);
                            work = false;
                        };
                    } else {
                        Console.gerror("The variable type was not set.", ["From: DuScript[Door] interpreter.", "Worker: __approve", "Line: " + line]);
                        work = false;
                    };
                } else {
                    Console.gerror("The sign of setting the value of the variable is not known.", ["From: DuScript[Door] interpreter.", "Worker: __approve", "?: " + text[2], "Line: " + line]);
                    work = false;
                };
            } else {
            ...
            Console.gerror("No variable name was specified.", ["From: DuScript[Door] interpreter.", "Worker: __approve", "Line: " + line]);
            work = false;
        };
    } else {
        Console.gerror("A command was executed that was not invoked in the line.", ["From: DuScript[Door] interpreter.", "Worker: __approve", "?: " + text.join(" "), "Line: " + line]);
        work = false;
    };
